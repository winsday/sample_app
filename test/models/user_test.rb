...
class UserTest < ActiveSupport::TestCase
  def setup
    @user = User.new(name:"example", email:"example@istic.ac.cn",
  ...
  test "email validateion should reject invalid addresses" do
    invalid_addresses = %w[user@example,com USER_at_foo.COM Auser.name@example. foo@bar_baz.com foo@bar+baz.cn]
